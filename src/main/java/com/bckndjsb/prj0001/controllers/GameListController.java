...
import com.bckndjsb.prj0001.dto.ReorderingDTO;
...
public class GameListController {
	...
	//Mapear a reordenacao da lista POST
	@PostMapping(value = "/{listId}/reordering")
	public void move(@PathVariable Long listId, @RequestBody ReorderingDTO body){
